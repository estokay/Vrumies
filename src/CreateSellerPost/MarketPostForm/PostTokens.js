...
const PostTokens = ({ value, onChange }) => {
  ...
  return (
    <div>
      <label className="mpf-form-label">Token Amount (Optional) <HelpPopover text="Tokens are used to boost visibility. You cannot post more tokens than you currently own." /></label>
