...
import { db } from "../firebase"; // adjust this path to your firebase.js
...
export default function useUpdateOrderStatus() {
  ...
  const updateOrderStatus = useCallback(async (orderId) => {
    ...
    try {
      ...
      const buyerCompleted = buyerInfo.buyerMarketCompleted || false;
      const sellerCompleted = sellerInfo.sellerMarketCompleted || false;
