...
const FilterPanelMobile = ({
  ...
  return (
    <div className="e-filter-overlay">
      <div className="e-filter-sheet">
        <div className="e-filter-sheet-header">
          <h3>Filters</h3>
          <FaTimes onClick={onClose} />
        </div>

        <div className="e-filter-sheet-body">
          {/* Sort */}
          <div className="e-filter-group">
            <label>Sort By</label>
          ...
          <button className="e-apply-btn" onClick={onClose}>
            Apply Filters
          </button>
        </div>
      </div>
