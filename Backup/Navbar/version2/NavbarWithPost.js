...
function NavbarWithPost() {
  ...
  useEffect(() => {
    ...
    if (showDropdown || showNotifications || showSocialDropdown || showDirectoryDropdown) {
  ...
  }, [showDropdown, showNotifications, showSocialDropdown, showDirectoryDropdown]);
      ...
      <nav className="navbar" style={{ position: 'relative', zIndex: 10 }}>
        <div className="navbar-left">
          ...
          <ul className="nav-links">
            ...
            <li><Link to="/events">Loadboard</Link></li>
          </ul>
        </div>
