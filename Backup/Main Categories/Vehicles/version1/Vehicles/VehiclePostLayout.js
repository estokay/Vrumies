...
import './VehiclePostLayout.css';

function VehiclePostLayout({ thumbnail, title, creator, date, views, likes, comments, duration, profilePic }) {
  return (
    <a href="/vehicle/123" className="vehicle-post-layout">
      ...
      <h4 className="vehicle-post-title">{(title || 'Title of Vehicle Post').toUpperCase()}</h4>
...
export default VehiclePostLayout;
