...
const EventPostForm = () => {
  ...
  const MAX_IMAGES = 7;
  const GOOGLE_API_KEY = 'AIzaSyAF-Y9M2YTMmMBu6RU7sDh4vRM9gFdC5MI'; // Replace with your API key
  ...
  return submitted ? (
    ...
    <form className="event-post-form" onSubmit={handleSubmit}>
      ...
      <div className="event-toggle-buttons-row">
        ...
        <img src={`${publicPath}/PostCreationIcons/Image-Icon.png`} alt="Image" onClick={() => toggleField('images')} className={activeField === 'images' ? 'active' : ''} />
        ...
        <img src={`${publicPath}/PostCreationIcons/Calendar-Icon.png`} alt="Calendar" onClick={() => toggleField('eventDateTime')} className={activeField === 'eventDateTime' ? 'active' : ''} />
