...
const DirectoryPostForm = () => {
  ...
  return submitted ? (
    ...
    <form className="directory-post-form" onSubmit={handleSubmit}>
      ...
      <input type="text" name="link" placeholder="Enter link" value={formData.link} onChange={handleChange} className={activeField === 'link' ? '' : 'directory-hidden-input'} />
      ...
      {/* Tokens */}
      <input type="number" name="tokens" placeholder="Enter token amount" value={formData.tokens} onChange={handleChange} className={activeField === 'tokens' ? '' : 'directory-hidden-input'} />
      ...
      {activeField === 'serviceLocation' && (
        <>
          ...
          {formData.serviceLocation === 'Business Address' && (
            <input type="text" name="businessAddress" placeholder="Enter business address" value={formData.businessAddress} onChange={handleChange} className="directory-post-form-input" />
          )}
        </>
      )}
