...
const VideoTextArea = () => {
  ...
  return (
    <div className="video-text-area">
      {/* Top row: VRUMIES/VIDEOS left, city/state center, date right */}
      <div className="video-top-row">
        <div className="video-top-left">VRUMIES / VIDEOS</div>
        <div className="video-top-center">{location}</div>
        <div className="video-top-right">Date Posted: {date}</div>
      </div>
