  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setNewCommentNotification({
        sellerId: post?.userId, // owner of the post
    ...
    <div className="event-comments-section">
      ...
      {newCommentNotification && (
        <SendNotificationComment
          ...
          clearNotification={() => setNewCommentNotification(null)} // optional but recommended
        />
      )}
    </div>
  );
