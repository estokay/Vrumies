      ...
      <div className="post-left">
        <div className="post-content">
          <div className="post-header">
            ...
            <PostDropMenu onClick={() => setShowDropMenu(true)} canDelete={isSeller} onDelete={handleDeletePost} canBlock={canBlock} onBlock={handleBlockUser} canAffiliate={canAffiliate} onAffiliate={handleAffiliate} />
          </div>
        ...
        <div className="price-row">
          ...
          <div className="add-to-cart-wrapper">
            <button
              ...
              title={!currentUser ? "Login to book freight" : ""}
            >
              BOOK FREIGHT
            </button>
          </div>
