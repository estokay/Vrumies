  ...
  return (
    <div style={{ ...styles.container, height: '260px' }}>
      <div style={styles.leftSide}>
        ...
        <p style={styles.subtitle}>MAKE A REQUEST POST TO ALL USERS FOR THE AUTOMOTIVE PRODUCTS OR SERVICES YOU ARE LOOKING FOR</p>
      </div>
...
const styles = {
  container: {
    ...
    backgroundImage: 'url("https://media.istockphoto.com/id/1271779268/photo/calling-roadside-assistance.jpg?s=612x612&w=0&k=20&c=JxOZbwpnSE_vxFWZ5Te1-Y4QrUMsiLFaDyXu_uMX1ok=")',
