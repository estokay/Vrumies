...
function Notifications({ isOpen, onClose }) {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { type: 'comment', title: 'Dodge Charger Hellcat with upgrades exhaust', from: 'SaraTheDrifter_Official', message: 'Very cool car, what is the title status of the vehicle?', link: '/marketpost/p6rZRJf885E0J9jWJsxD', createdAt: 'January 14, 2026 at 12:30:43 PM UTC-6', read: true },
    { type: 'comment', title: 'My new Vlog at the local car meeet in San Antonio', from: 'Mikefromike1995', message: 'Wow very cool car event you went to, glad the cops didn\'t...', link: '/videopost/OutWvBSij0qVddCRIplX', createdAt: 'January 14, 2026 at 9:26:22 AM UTC-6', read: true },
  ]);
