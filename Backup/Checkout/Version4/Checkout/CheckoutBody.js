...
const CheckoutBody = forwardRef(() => {
  ...
  const [formData, setFormData] = useState({
    ...
    billingState: "",
    billingZip: "",
    useBillingAsShipping: false, // default OFF
  });
  ...
  // Copy billing info to delivery if toggle ON
  useEffect(() => {
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData((prev) => ({
                    ...
                    // Clear delivery fields if toggle is OFF
                    fullName: checked ? prev.billingFullName : "",
                    email: checked ? prev.email : "",
                    address: checked ? prev.billingAddress : "",
                    city: checked ? prev.billingCity : "",
                    state: checked ? prev.billingState : "",
                    zip: checked ? prev.billingZip : "",
                  }));
                }}
              />
